...
|---|---|---|---|
| Handshake | URL, query, headers, cookies, negotiated ids, subprotocol | Entry contract before business messages exist | Calling handshake success full protocol success |
